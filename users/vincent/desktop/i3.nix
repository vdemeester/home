...
in
{
  ...
  xsession.windowManager.i3 = {
    ...
    config = {
      ...
      keycodebindings = {
        "Mod4+Shift+24" = "kill";
        "Mod4+33" = "exec \"${pkgs.rofi}/bin/rofi -show combi -modi 'run,window,ssh,combi' -kb-row-select 'Tab' -kb-row-tab '' -location 2 -hide-scrollbar -separator-style solid -font 'Ubuntu Mono 14'";
        # "Mod4+space" = "";
        # focus window
        "Mod4+44" = "focus left";
        "Mod4+45" = "focus down";
