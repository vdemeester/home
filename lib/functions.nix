{ lib }:
let
  # Helper functions for machine configurations
...
in
{
  ...
  # Create isCurrentHost function that takes hostname as parameter
  isCurrentHost = isCurrentHost;

  # Create syncthingMachinesWithFolder function that takes hostname as parameter
  syncthingMachinesWithFolder = syncthingMachinesWithFolder;
  ...
  */
  ...
  generateSyncthingFolders =
    machine: machines: folders: hostname:
    lib.attrsets.mapAttrs' (
      name: value:
